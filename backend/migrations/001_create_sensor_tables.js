/**
 * Database Migration: Sensor Management Tables
 * Run this to setup sensor-related tables
 */
...
CREATE TABLE IF NOT EXISTS sensor_error_log (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  sensor_id INT NOT NULL,
  error_type ENUM('connection', 'data', 'validation', 'timeout', 'other') NOT NULL,
  error_message TEXT,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Sensor error tracking';

-- Tabel untuk device/perangkat yang memiliki sensor
CREATE TABLE IF NOT EXISTS devices (
  id INT PRIMARY KEY AUTO_INCREMENT,
  name VARCHAR(255) NOT NULL UNIQUE COMMENT 'Nama device (Panel A, Panel B, Trafo Utama, etc)',
  type ENUM('panel', 'trafo', 'weather_station', 'gateway', 'other') NOT NULL,
...
-- Tabel untuk sensor configuration backup
